...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public ADA = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract BitcoinMJ is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BitcoinMJ";
    string constant _symbol = "BTCMJ";
    ...
    uint256 public _maxWallet = 299 * (10**5) * (10 ** _decimals);
    uint256 public buyBackUpperLimit = 2 * 10**12;
    ...
    uint256 pushChartReflectionFee = 400;
    ...
    function lsetGrandLaunch1() public onlyOwner() {
        ...
        _maxWallet = 15 * (10**6) * (10 ** _decimals);
        // Sniper prevention
        burnFee = 10;
        reflectionFee = 1000;
        marketingFee = 2750;
    ...
    function lsetGrandLaunch2() public onlyOwner() {
        _maxTxAmount = _totalSupply;
        _maxWallet = 299 * (10**5) * (10 ** _decimals);
        burnFee = 10;
